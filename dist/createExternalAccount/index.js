 ...
 */
function default_1({ clientID, developerAPIKey, types, accountId, ExtAccountfullname, Extnickname, ExtRoutingnumber, ExtAccountnumber, accountType, }) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            return yield (0, base_1.baseApi)("POST", "createExternalAccount", payload);
        }
        catch (error) {
