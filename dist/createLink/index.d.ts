 ...
 */
export default function ({ clientID, developerAPIKey, firstEntryType, firstEntry, relatedEntryType, relatedEntry, linkType, notes, primary_value }: CreateLinkRequest): Promise<CreateLinkResponse>;
