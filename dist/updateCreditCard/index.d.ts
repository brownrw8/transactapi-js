 ...
 */
export default function ({ clientID, developerAPIKey, accountId, creditCardName, creditCardNumber, expirationDate, cvvNumber, cardType, }: UpdateCreditCardRequest): Promise<UpdateCreditCardResponse>;
