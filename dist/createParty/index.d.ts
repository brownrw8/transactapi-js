 ...
 */
export default function ({ clientID, developerAPIKey, domicile, firstName, lastName, dob, primCountry, primAddress1, primAddress2, primCity, primState, primZip, emailAddress, }: CreatePartyRequest): Promise<CreatePartyResponse>;
