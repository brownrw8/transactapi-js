 ...
 */
function default_1({ clientID, developerAPIKey, partyId, domicile, firstName, lastName, dob, primCountry, primAddress1, primAddress2, primCity, primState, primZip, emailAddress, }) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            return yield (0, base_1.baseApi)("POST", "updateParty", payload);
        }
        catch (error) {
