import { CreateExternalAccountRequest, CreateExternalAccountResponse } from "./types";
/**
 ...
 */
export default function ({ clientID, developerAPIKey, types, accountId, ExtAccountfullname, Extnickname, ExtRoutingnumber, ExtAccountnumber, accountType, }: CreateExternalAccountRequest): Promise<CreateExternalAccountResponse>;
