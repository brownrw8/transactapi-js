 ...
 */
export default function ({ clientID, developerAPIKey, accountId, offeringId, tradeId }: SendSubscriptionDocumentRequest): Promise<SendSubscriptionDocumentResponse>;
